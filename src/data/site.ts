...
export const fleet: FleetItem[] = [
  {
    ...
    videos: [
      ...
      },
      {
        ...
        sourceLabel: "Amanda Machinery",
        sourceUrl: "https://www.youtube.com/watch?v=uvwQrfmTXTQ",
      },
    ],
    ...
    videos: [
      {
        ...
        sourceLabel: "EVANGEL CHINA",
        sourceUrl: "https://www.youtube.com/watch?v=PYzQMpRK8t0",
      },
      {
        title: "Essai terrain SY215C",
        file: "/media/videos/sany-sy215c-test.mp4",
        sourceLabel: "Deals on Wheels NZ",
        sourceUrl: "https://www.youtube.com/watch?v=TW53Ix0CmsA",
      },
    ],
  },
  {
    ...
    videos: [
      {
        ...
        sourceLabel: "CRYSTAL Tractor & Equipment",
        sourceUrl: "https://www.youtube.com/watch?v=Dn7dYYKB2vM",
      },
      {
        title: "Apercu rapide SW305K",
        file: "/media/videos/sany-sw305k-preview.mp4",
        sourceLabel: "UnionFarmEquipment",
        sourceUrl: "https://www.youtube.com/watch?v=fVyhLOKmrYE",
      },
    ],
  },
];
